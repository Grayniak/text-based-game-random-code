...
def chair():
  if (chairv == "0"):
    print("You wake up in an empty room. Upon looking around, you see that the room is filled with nothing but a dresser, a desk, a broken radio, and door with a pattern that seems to change every time you \nlook away from it.")
  ans == input("\nWhat do you do?\n1. Walk to the dresser\n2. Walk to the desk\n3. Walk to the radio\n4. Walk to the door\n\n")
  chairv = "1"
